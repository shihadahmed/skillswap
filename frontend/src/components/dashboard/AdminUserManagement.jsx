...
export default function AdminUserManagement() {
  ...
  const avatar = (u) =>
    u.image || 'https://placehold.co/80x80?text=' + encodeURIComponent((u.name || 'U')[0]);
                ...
                <tr key={u._id} className="border-b border-line last:border-0">
                  ...
                  <td className="py-3 px-4 text-right whitespace-nowrap">
                    ...
                    <button
                      ...
                      className="text-muted hover:underline text-xs font-semibold mr-3 disabled:opacity-50"
                    >
