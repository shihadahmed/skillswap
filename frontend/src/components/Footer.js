          ...
          <div className="flex gap-3 mt-5">
            {socials.map(({ label, href, svg }) => (
              <a
                ...
                rel="noreferrer"
                aria-label={label}
                className="grid place-items-center w-9 h-9 rounded-lg border border-line text-ink hover:text-brand hover:border-brand hover:bg-brand/5 transition-colors"
              >
                {svg}
              </a>
            ))}
